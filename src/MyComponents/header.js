                           ...
                           <div className="pq-menu-contain">
                              <ul id="pq-main-menu" className="navbar-nav ml-auto">
                                 ...
                                 <li className="menu-item ">
                                    <a href="#">Our Services</a><i className="fa fa-chevron-down pq-submenu-icon"></i>
                                    <ul className="sub-menu">
                                       <li className="menu-item "><a href="about-us.html">About Us</a></li>
                                       <li className="menu-item "><a href="our-services.html">Our Services</a></li>
                                       <li className="menu-item "><a href="our-process.html">Our Process</a></li>
                                       <li className="menu-item "><a href="our-plan.html">Our Plans</a></li>
                                       <li className="menu-item-has-children">
                                          <a href="#">Our Doctors</a><i className="fa fa-chevron-down pq-submenu-icon"></i>
                                          <ul className="sub-menu">
                                             <li className="menu-item "><a href="doctor-1.html">Doctors 1</a></li>
                                             <li className="menu-item "><a href="our-doctor.html">Our Doctor Details</a>
                                             </li>
                                          </ul>
                                       </li>
                                       <li className="menu-item "><a href="make-appoinment.html"></a></li>
                                       <li className="menu-item "><a href="faq.html"> </a></li>
                                       <li className="menu-item "><a href="404.html"></a></li>
                                    </ul>
                                 </li>
                                 <li className="menu-item ">
                                    <a href="#">About Us</a>
